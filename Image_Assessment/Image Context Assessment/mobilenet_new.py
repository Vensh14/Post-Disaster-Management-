...
def train_model(model, train_loader, val_loader):
    ...
    # MobileNetV3 uses "classifier", not "fc"
...
print("\n")
print("=" * 70)
print("MOBILENETV3-SMALL CONTEXTUAL ANALYSIS - 550 IMAGES")
print("=" * 70)
...
for target in TARGETS:
    ...
    cm_path = os.path.join(
        OUTPUT_DIR,
        f"{safe_target}_confusion_matrix_550.csv"
    )
    ...
    model_path = os.path.join(
        OUTPUT_DIR,
        f"MobileNetV3_550_{safe_target}.pth"
    )
...
summary_path = os.path.join(
    OUTPUT_DIR,
    "MobileNetV3_550_Comparison_Summary.csv"
)
...
print("\n")
print("=" * 100)
print("FINAL COMPARISON - ALL TARGETS (550 IMAGES)")
print("=" * 100)
